...
class Seedling extends ResourceController
{
	use ResponseTrait;

	protected $modelName = 'App\Models\SeedlingModel';
	...
	public function create()
	{
		...
		$this->validation->run($data, 'seedling_create');
