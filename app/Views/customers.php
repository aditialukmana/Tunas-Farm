...
<div class="modal fade" id="modal_create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form method="post" action="<?php echo base_url('api/customers'); ?>" id="create_Customer_form">
        ...
        <div class="modal-body">
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" id="investment" name="investment" class="form-control" autocomplete="off">
          </div>
        </div>
