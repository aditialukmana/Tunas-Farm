                    ...
                    <form class="user" action="<?= route_to('login') ?>" method="post">
                                    ...
                                    <?php if ($config->validFields === ['email']): ?>
                                        <div class="form-group">
                                            <input type="email" class="form-control round <?php if(session('errors.login')) : ?>is-invalid<?php endif ?>"
                                    ...
                                    <?php else: ?>
                                        <div class="form-group">
                                            <input type="text" class="form-control round <?php if(session('errors.login')) : ?>is-invalid<?php endif ?>"
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control round <?php if(session('errors.password')) : ?>is-invalid<?php endif ?>" placeholder="<?=lang('Auth.password')?>"
                                                name="password" >
                                        </div>
