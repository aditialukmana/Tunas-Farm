  ...
  <div class="block-header">
    <div class="row clearfix">
      <div class="col-md-6 col-sm-12">
        <h1>Actuator Sites Setup</h1>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>"><i class="icon-home"></i></a></li>
            <li class="breadcrumb-item active">Actuator Sites Setup</li>
          </ol>
        </nav>
      </div>
    </div>
      ...
      <div class="card">
        <div class="text-left" style="margin-bottom:10px;margin-top:20px">
          <button type="button" class="btn btn-round btn-success" data-toggle="modal" data-target="#modal_create">Create
            New Actuator Site</button>
        </div>
        <div class="body">
          <div class="table-responsive">
            <table class="table table-hover table-custom spacing5" id="tableActuatorSites" data-url="<?= base_url('api/actuatorsites'); ?>">
              <thead>
                <tr>
                  <th>Site</th>
                  <th>Floor</th>
    ...
    <div class="modal-content">
      <form id="create_ActuatorSites_form">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Create Actuator Site</h5>
