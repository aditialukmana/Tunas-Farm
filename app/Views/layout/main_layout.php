...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('public/'); ?>/theme/vendor/jquery-datatable/fixedeader/dataTables.fixedcolumns.bootstrap4.min.css">
  <link rel="stylesheet" href="<?php echo base_url('public/'); ?>/theme/vendor/jquery-datatable/fixedeader/dataTables.fixedheader.bootstrap4.min.css">
  <link rel="stylesheet" href="<?php echo base_url('public/'); ?>/theme/vendor/sweetalert/sweetalert.css" />
  <!-- <link rel="stylesheet" href="/theme/vendor/select2-4.0.13/dist/css/select2.min.css"> -->
  <link rel="stylesheet" href="<?php echo base_url('public/'); ?>/theme/vendor/dropify/css/dropify.min.css">
